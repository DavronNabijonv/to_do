        ...
        <div className="formPart max-w-[500px] w-full m-auto p-[10px] pt-[20px] rounded-[10px] mt-[10%] border-indigo-700 border-4 ">
          <form className="flex flex-col gap-[20px]" onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="p-[10px] rounded-[10px] text-gray-600 text-[18px] border-[1px] border-purple"
              required
            />
            <input
              type="submit"
              value="Register"
              className="bg-red-100 p-[10px] rounded-[10px] text-gray-600 text-[18px] border-[1px] border-purple w-[200px] m-auto cursor-pointer"
            />
          </form>
          <div className="toRegister flex flex-row w-full justify-center items-center gap-[20px] ">
            <p className="text-[18px]">Tizimga kirish.</p>
            <button onClick={changeTogle}>Log In</button>
          </div>
        </div>
      </div>
    </div>
